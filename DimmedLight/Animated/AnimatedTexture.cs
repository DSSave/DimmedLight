...
namespace DimmedLight.Animated
{
    public class AnimatedTexture
    {
        ...
        {
            var clone = new AnimatedTexture(this.Origin, this.Rotation, this.Scale, this.Depth);
            clone.LoadFromTexture(this.myTexture, this.framecount, this.framerow, this.framesPerSecond, this.startrow, this.Overload);
            return clone;
        }
