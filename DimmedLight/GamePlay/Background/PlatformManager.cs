...
namespace DimmedLight.GamePlay.Background
{
    public class PlatformManager
    {
        ...
        public PlatformManager(Texture2D texture, Texture2D asset, int copies)
        {
            ...
            int y = screenHeight - texture.Height + 115;
        ...
        public void Update(float platformSpeed, float deltaTime)
        {
            ...
            for (int i = 0; i < Positions.Length; i++) Positions[i].X -= platformSpeed;
